local mappings = {
	...
	n = {
		...
		["<leader>sd"] = { "<Cmd>Trouble lsp_definitions", "Show LSP definitions in a Trouble panel" },
		["<leader>si"] = { "<Cmd>Trouble lsp_implementations", "Show LSP implementations in a Trouble panel" },
		["<leader>sr"] = { "<Cmd>Trouble lsp_references", "Show LSP references in a Trouble panel" },
		["<leader>st"] = { "<Cmd>Trouble lsp_type_defitions", "Show LSP type defitions in a Trouble panel" },
		["<A-x>"] = { "<Cmd>ToggleTerm direction=float<CR>", "Open floating terminal" },
		["<A-t>"] = { "<Cmd>ToggleTerm direction=vertical<CR>", "Open vertical terminal" },
		["<A-h>"] = { "<Cmd>ToggleTerm direction=horizontal<CR>", "Open horizontal terminal" },
